...
public class STLRenderer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String outputPath = "colored_pir.png";
    ...
    private static void centerObject(SceneObject sceneObject, int width, int height) {
        ...
        sceneObject.rotate(new Vector(1, 0, 0, null),80); // Rotate around X axis
        sceneObject.rotate(new Vector(0, 1, 0, null), 80); // Rotate around Y axis
        sceneObject.rotate(new Vector(0, 0, 1, null), 15); // Rotate around Z axis
    }
}